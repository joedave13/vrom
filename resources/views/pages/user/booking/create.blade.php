@extends('layouts.user.app', ['title' => 'Car Booking'])
        ...
        <section class="bg-darkGrey relative py-[70px]">
            <div class="container">
                ...
                <div class="flex items-center gap-5 lg:justify-between">
                    <!-- Form Card -->
                    <form id="car-booking-form" action="{{ route('booking.store', $car) }}" method="POST"
                        ...
                        <div class="grid grid-cols-2 items-center gap-y-6 gap-x-4 lg:gap-x-[30px]">
                            ...
                            <div class="col-span-2 grid-cols-2 gap-y-6 gap-x-4 lg:gap-x-[30px] hidden">
                                ...
                                <div class="flex flex-col col-span-1 gap-3">
                                    <label for="dateUntil" class="text-base font-semibold text-dark">
                                        Until (result)
                                    </label>
                            ...
                            <div class="col-span-2 grid grid-cols-2 gap-y-6 gap-x-4 lg:gap-x-[30px] relative"
                                ...
                                <div class="flex flex-col col-span-1 gap-3">
                                    ...
                                    @if ($errors->has('start_date'))
                                        <ul class="text-sm" style="color: #dc2626;">
                                            @foreach ((array) $errors->get('start_date') as $error)
                                                <li>{{ $error }}</li>
                                            @endforeach
                                        </ul>
                                    @endif
                                ...
                                <div class="flex flex-col col-span-1 gap-3">
                                    ...
                                    @if ($errors->has('end_date'))
                                        <ul class="text-sm" style="color: #dc2626;">
                                            @foreach ((array) $errors->get('end_date') as $error)
                                                <li>{{ $error }}</li>
                                            @endforeach
                                        </ul>
                                    @endif
                            ...
                            <div class="flex flex-col col-span-2 gap-3">
                                ...
                                @if ($errors->has('address'))
                                    <ul class="text-sm" style="color: #dc2626;">
                                        @foreach ((array) $errors->get('address') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </ul>
                                @endif
                            ...
                            <div class="flex flex-col col-span-1 gap-3">
                                ...
                                @if ($errors->has('city'))
                                    <ul class="text-sm" style="color: #dc2626;">
                                        @foreach ((array) $errors->get('city') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </ul>
                                @endif
                            ...
                            <!-- Post Code -->
                            <div class="flex flex-col col-span-1 gap-3">
                                <label for="zip_code" class="text-base font-semibold text-dark">
                                    ZIP Code
                                </label>
                                ...
                                @if ($errors->has('zip_code'))
                                    <ul class="text-sm" style="color: #dc2626;">
                                        @foreach ((array) $errors->get('zip_code') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </ul>
                                @endif
                            ...
                            <div class="col-span-2 mt-[26px]">
                                ...
                                <div class="p-1 rounded-full bg-primary group">
                                    <a href="javascript:void(0)"
                                        onclick="document.getElementById('car-booking-form').submit()"
                                        class="btn-primary">
                                        <p>
                                            Continue
                                        </p>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('user-assets/js/dateRangePicker.js') }}"></script>
@endpush
